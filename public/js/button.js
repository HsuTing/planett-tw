...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  _reactDom2.default.render(_react2.default.createElement(_index2.default, null), document.getElemenetById('root'));
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _basic = __webpack_require__(169);
	...
	var ButtonPage = function (_React$Component) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _planettStyle = __webpack_require__(210);

	var _planettStyle2 = _interopRequireDefault(_planettStyle);
	...
	var Button = function (_React$Component) {
	  ...
	  function Button(props) {
	    ...
	    _this.state = {
	      isClick: _this.props.defaultClicked === undefined ? false : _this.props.defaultClicked
	    };
	    return _this;
	  }
	  ...
	  _createClass(Button, [{
	    key: 'render',
	    value: function render() {
	      this.__check_clicked__();

	      var output = this.__get_output__.bind(this)();
	      output = this.__add_default__(output);
	      output = this.__add_clicked__.bind(this)(output);

	      return _react2.default.createElement('button', output, this.props.children);
	    }
	  }, {
	    key: '__onClick__',
	    value: function __onClick__() {
	      this.setState({ isClick: !this.state.isClick });
	    }
	  }, {
	    key: '__check_clicked__',
	    value: function __check_clicked__() {
	      (0, _invariant2.default)(!(this.props.clicked !== undefined && this.props.onClick === undefined), "You provided a 'clicked' prop to a button without an 'onClick' handler. This will render a not changeable button. If the button should be mutable use 'defaultClicked'. Otherwise, set 'onClick'.");
	    }
	  }, {
	    key: '__get_output__',
	    value: function __get_output__() {
	      var output = {};

	      for (var attr in this.props) {
	        output[attr] = this.props[attr];
	      }
	    ...
	    key: '__add_default__',
	    value: function __add_default__(output) {
	      var defaultStyle = {
	        height: '35px',
	        color: 'white',
	        background: 'rgb(125, 241, 191)',
	        borderRadius: '10px',
	        outline: '0px',
	        borderWidth: '0px',
	        cursor: 'pointer'
	      ...
	      if (output.style !== undefined) {
	        output.style = (0, _merge2.default)(defaultStyle, output.style);
	      } else {
	        output.style = defaultStyle;
	      }
	      output = (0, _merge2.default)({ onClick: this.__onClick__.bind(this) }, output);

	      return output;
	    }
	  }, {
	    key: '__add_clicked__',
	    value: function __add_clicked__(output) {
	      var clickedStyle = {
	        background: 'rgb(49, 107, 130)'
	      };

	      var isClick = this.props.clicked === undefined ? this.state.isClick : this.props.clicked;
	      var isDisabled = this.props.disabled === undefined ? false : this.props.disabled;
	      if (isClick && !isDisabled) {
	        if (output.style !== undefined) {
	          output.style = (0, _merge2.default)(output.style, clickedStyle, output.clickedStyle);
	        } else {
	          output.style = (0, _merge2.default)(output.style, clickedStyle);
	        }
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  var ReactInvalidSetStateWarningDevTool = __webpack_require__(192);
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(185);
	var ReactElement = __webpack_require__(177);
	var ReactPropTypeLocations = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = __webpack_require__(203);
