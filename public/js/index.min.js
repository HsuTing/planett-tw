...
/***/ function(module, exports, __webpack_require__) {
	...
	var _code = __webpack_require__(232);

	var _code2 = _interopRequireDefault(_code);

	var _basic = __webpack_require__(233);

	var basic = _interopRequireWildcard(_basic);

	var _changeStyle = __webpack_require__(239);

	var changeStyle = _interopRequireWildcard(_changeStyle);

	var _defaultClicked = __webpack_require__(240);

	var defaultClicked = _interopRequireWildcard(_defaultClicked);

	var _disabled = __webpack_require__(241);

	var disabled = _interopRequireWildcard(_disabled);

	var _clicked = __webpack_require__(242);

	var clicked = _interopRequireWildcard(_clicked);

	var _inverted = __webpack_require__(243);

	var inverted = _interopRequireWildcard(_inverted);

	var _group = __webpack_require__(244);

	var group = _interopRequireWildcard(_group);

	var _groupDefault = __webpack_require__(247);

	var groupDefault = _interopRequireWildcard(_groupDefault);
	     ...
	     _createClass(ButtonPage, [{
	          ...
	          value: function render() {
	               return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_code2.default, { data: ['npm install planett-button --save'] }),
	                    _react2.default.createElement(
	                         'h5',
	                         null,
	                         '- Install button group'
	                    ),
	                    _react2.default.createElement(_code2.default, { data: ['npm install planett-button-group --save'] }),
	                    ...
	                    _react2.default.createElement('div', { title: 'Basic',
	                         data: basic
	                    }),
	                    _react2.default.createElement('div', { title: 'Change style',
	                         data: changeStyle
	                    }),
	                    _react2.default.createElement('div', { title: 'Default clicked',
	                         data: defaultClicked
	                    }),
	                    _react2.default.createElement('div', { title: 'Disabled',
	                         data: disabled
	                    }),
	                    _react2.default.createElement('div', { title: 'Control clicked',
	                         subtitle: 'You can set \'clicked\' by yourself, but you must give a function \'onClick\'. Otherwise, you must use \'defaultClicked\'.',
	                         data: clicked
	                    }),
	                    _react2.default.createElement('div', { title: 'Inverted',
	                         data: inverted
	                    }),
	                    _react2.default.createElement('div', { title: 'Group',
	                         data: group
	                    }),
	                    _react2.default.createElement('div', { title: 'Default group clicked',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Example = function (_React$Component) {
	  ...
	  _createClass(Example, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', {
	        ...
	        if (child.type === 'div') {
	          ...
	          }, _react2.default.createElement('h1', null, child.props.title), _react2.default.createElement('h5', {
	            style: {
	              lineHeight: '30px'
	            }
	          }, _react2.default.Children.map(_this2.__parse_subtitle__(child.props.subtitle), function (child, index) {
	            return child;
	          })), child.props.data.component, _react2.default.createElement(_code2.default, {
	            data: child.props.data.str
	          }), _react2.default.createElement('br', null), _react2.default.createElement('br', null), _react2.default.createElement('br', null));
	        }
	    ...
	    key: '__parse_subtitle__',
	    value: function __parse_subtitle__(text) {
	      if (text !== undefined) {
	        return text.split('\'').map(function (subtext, index) {
	          if (index % 2 === 1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.str = exports.component = undefined;

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _planettButton = __webpack_require__(234);

	var _planettButton2 = _interopRequireDefault(_planettButton);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var component = exports.component = _react2.default.createElement(
	  _planettButton2.default,
	  null,
	  'Basic'
	);

	var str = exports.str = ['<Button>Basic</Button>'];

/***/ },
/* 234 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__(235).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _merge = __webpack_require__(236);

	var _merge2 = _interopRequireDefault(_merge);

	var _planettStyle = __webpack_require__(238);
	...
	var Button = function (_React$Component) {
	  ...
	  _createClass(Button, [{
	    ...
	    value: function render() {
	      ...
	      var output = (0, _merge2.default)({}, this.props);
	    ...
	    value: function __add_default__(output) {
	      ...
	      if (this.props.inverted) {
	        defaultStyle = (0, _merge2.default)(defaultStyle, _planettStyle2.default.Color, _planettStyle2.default.Border);
	      } else {
	        defaultStyle = (0, _merge2.default)(defaultStyle, _planettStyle2.default.Background);
	      }
	    ...
	    value: function __add_clicked__(output) {
	      var clickedStyle = this.props.inverted ? _planettStyle2.default.Background : _planettStyle2.default.BackgroundClicked;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<Button style={{background: \'red\'}}', '        clickedStyle={{background: \'blue\'}}', '>Change style</Button>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<Button defaultClicked', '>Default is Clicked</Button>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<Button disabled', '>disabled</Button>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<Button onClick={ () => { alert(\'click\') } }', '        clicked={true}', '>Clicked</Button>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<Button inverted', '>Inverted</Button>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _planettButtonGroup = __webpack_require__(245);

	var _planettButtonGroup2 = _interopRequireDefault(_planettButtonGroup);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var component = exports.component = _react2.default.createElement(
	  _planettButtonGroup2.default,
	  null,
	  _react2.default.createElement(
	    _planettButton2.default,
	    null,
	...
	var str = exports.str = ['<ButtonGroup>', '  <Button>Buuton1</Button>', '  <Button>Buuton2</Button>', '  <Button>Buuton3</Button>', '</ButtonGroup>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupButton = function (_React$Component) {
	  _inherits(GroupButton, _React$Component);

	  function GroupButton(props) {
	    _classCallCheck(this, GroupButton);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GroupButton).call(this, props));

	    _this.state = {
	      now: _this.props.default === undefined ? 0 : _this.props.default
	    };
	    return _this;
	  }

	  _createClass(GroupButton, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;

	      var childrens = _react2.default.Children.map(this.props.children, function (child, index) {
	        (0, _invariant2.default)(!(child.type.name !== _react2.default.createElement(_planettButton2.default, null).type.name), 'the children of "planett-button-group" must be "planett-button"');
	        ...
	        var onClick = function onClick(event) {
	          ...
	          _this2.__click__.bind(_this2, index)();
	        };

	        return _react2.default.cloneElement(child, {
	          clicked: index === _this2.state.now,
	          onClick: onClick.bind(_this2)
	        });
	      });

	      return _react2.default.createElement('div', this.props, childrens);
	    }
	  }, {
	    key: '__click__',
	    value: function __click__(index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var str = exports.str = ['<ButtonGroup default={1}>', '  <Button>Buuton1</Button>', '  <Button>Buuton2</Button>', '  <Button>Buuton3</Button>', '</ButtonGroup>'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index3 = __webpack_require__(251);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_reactRouter.Route, { path: 'Circle', component: _index4.default }),
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _planettButtonGroup2.default,
	          null,
	          ['Button', 'Circle'].map(function (d, index) {
	            return _react2.default.createElement(
	              _planettButton2.default,
	              { key: index,
	                onClick: _this2.__click__.bind(_this2, d)
	              },
	              d
	            );
	          })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CirclePage = function (_React$Component) {
	  _inherits(CirclePage, _React$Component);

	  function CirclePage() {
	    _classCallCheck(this, CirclePage);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CirclePage).apply(this, arguments));
	  }
	  ...
	  _createClass(CirclePage, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_code2.default, { data: ['npm install planett-circle --save'] }),
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Example'
